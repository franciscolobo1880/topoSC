The code foundations are written within the package Quantica.jl. The folder /src/builders contains all lattice and Hamiltonian builds of various theorical models, namely:
        - Kitaev chain
        - SSH chain
